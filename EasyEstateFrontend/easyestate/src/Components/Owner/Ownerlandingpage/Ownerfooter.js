...
import '../../Customer/Customerlandingpage/Customerfooter.css'; // Import your CSS file
            ...
            <Container>
                <Row>
                    ...
                    <Col md={3} className="footer-col">
                        ...
                        <ul>
                            <li><a href="/ownerlanding">Home</a></li>
                            <li><a href="/Ownerproperties">My Properties</a></li>
                            <li><a href="/Propertyrequests">View Requests</a></li>
                            <li><a href="/Subscriptiondata">Subscription</a></li>
                        </ul>
                    </Col>
